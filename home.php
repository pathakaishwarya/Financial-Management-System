...
<nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
             <a class="nav-link" href="MutualFunds.php" target="_blank">Sanitizer</a>
         </li>

        <li class="nav-item">
            <a class="nav-link" href="about.php" target="_blank">TPA</a>
         </li>

        <li class="nav-item">
            <a class="nav-link" href="services.php" target="_blank">Cloud</a>
         </li>
...
<h2> Data Sharing with Sensitive Information Hiding for Secure Cloud Storage.</h2>
